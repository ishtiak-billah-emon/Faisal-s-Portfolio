        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative aspect-square max-w-md mx-auto rounded-3xl overflow-hidden shadow-card">
                <div className="w-full h-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                  <div className="text-center text-white p-8">
                    <span className="text-8xl font-poppins font-bold opacity-20">∑</span>
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
              With over 5 years of experience in education, I've dedicated my career to 
              transforming the way students perceive mathematics. My mission is simple: 
              make math enjoyable and accessible for everyone.
            </p>

            <p className="text-muted-foreground mb-8 leading-relaxed">
              At <span className="gold-highlight">10 Minute School</span>, I've had the privilege of 
              reaching hundreds of thousands of students across Bangladesh, helping them overcome 
              their fear of mathematics and excel in their academic journey.
            </p>
